								...
								<div class="col-lg-12">
										<div class="card">
											<div class="row card-header border-bottom">
												<h3 class="col-md-6 card-title">Manage Subject</h3>
                                                <a class="col-md-6 left login100-form-btn btn-primary" href="{{route('subjectFrom')}}">New Subject</a>
											</div>
											<div class="card-body">
