				...
				<div>
					...
					<div class="container-login100">
						<div class="wrap-login100 p-0">
							<div class="card-body">
								<form action="{{route('registerSubmit')}}" method="POST" class="login100-form validate-form">
                                    @csrf
                                    ...
                                    @endif
                                    <div class="container-login100-form-btn d-flex gap-2">
                                    ...
                                    <!-- <div>
                                        <div class="row-login100-form-btn d-flex gap-2 mb-4">

                                            <button type="button" class="col-md-6 login100-form-btn btn-primary role-btn" data-role="student">
                                                As a Student
                                            </button>

                                            <button type="button" class="col-md-6 login100-form-btn btn-primary role-btn" data-role="trainer">
                                                As a Trainer
                                            </button>
