                        ...
                        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                            <div class="card overflow-hidden">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <h3 class="mb-2 fw-semibold">{{count($owneds)}}</h3>
                                            <p class="text-muted fs-13 mb-0">Owend Courses</p>
                        ...
                        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                            <div class="card overflow-hidden">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <h3 class="mb-2 fw-semibold">{{count($pendings)}}</h3>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <p class="text-muted fs-13 mb-0">Completed</p>
                            ...
                            <div class="card product-sales-main">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="" class="table text-nowrap mb-0 table-bordered">
                                            <thead class="table-head">
                                                <tr>
                                                    <th class="bg-transparent border-bottom-0">Sl</th>
                                                    <th class="bg-transparent border-bottom-0 wp-15">Teacher Name</th>
                                                    <th class="bg-transparent border-bottom-0">Course Name</th>
                                                    <th class="bg-transparent border-bottom-0">Purchesh Date</th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody class="table-body">
                                                ...
                                                <tr>
                                                    <td class="text-muted fs-14 fw-semibold"><a href="#" class="text-dark" data-bs-target="#Vertically" data-bs-toggle="modal" >{{ $loop->iteration }}</a></td>

                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <span class="data-image avatar avatar-md rounded-circle"
                                                                style="background-image: url('{{ asset(optional($owned->courseModule->creator->image)->image) }}')">
                                                            </span>
                                                            <div class="user-details ms-2">
                                                                <h6 class="mb-0">{{optional($owned->courseModule->creator)->name}}</h6>
                                                                <span class="text-muted fs-12">{{optional($owned->courseModule->creator)->email}}</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="text-muted fs-14 fw-semibold"><a href="#" class="text-dark" data-bs-target="#Vertically" data-bs-toggle="modal" >
                                                        {{ optional($owned->courseModule)->course_name ?? 'Course Removed' }}
                                                    </a></td>
                                                    <td class="text-danger fs-14 fw-semibold">{{$owned->created_at }}</td>
                                            ...
                                            <tbody class="table-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <span class="data-image avatar avatar-md rounded-circle"
                                                                style="background-image: url('{{ asset(optional($pending->courseModule->creator->image)->image) }}')">
                                                            </span>
                                                            <div class="user-details ms-2">
                                                                <h6 class="mb-0">{{optional($pending->courseModule->creator)->name}}</h6>
                                                                <span class="text-muted fs-12">{{optional($pending->courseModule->creator)->email}}</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="text-muted fs-14 fw-semibold"><a href="#" class="text-dark" data-bs-target="#Vertically" data-bs-toggle="modal" >
                                                        {{ optional($pending->courseModule)->course_name ?? 'Course Removed' }}
                                                    </a></td>
                                                    <td class="text-danger fs-14 fw-semibold">{{$pending->created_at }}</td>
