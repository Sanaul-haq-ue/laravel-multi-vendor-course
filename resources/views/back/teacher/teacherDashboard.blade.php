                        ...
                        <div class="col-12 col-sm-12">
                            <div class="card product-sales-main">
                                <div class="card-header border-bottom">
                                    <h3 class="card-title mb-0">Approved Section</h3>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="" class="table text-nowrap mb-0 table-bordered">
                                            ...
                                            <tbody class="table-body">
                                                ...
                                                <tr>
                                                    <td class="text-muted fs-14 fw-semibold"><a href="#" class="text-dark" data-bs-target="#Vertically" data-bs-toggle="modal" >0</a></td>
                                                    ...
                                                    <td class="text-danger fs-14 fw-semibold">0</td>
